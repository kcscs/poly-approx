...
int main() {
  ...
  // 32, 5e-8); SegmentedChebyshevApproximator<double> cheb(sind2, 0.0, 2.0,
  // 128, 5e-16);
  ...
  Eigen::Vector3d eye(10,-2,7);
  Eigen::Vector3d light(0,-1,0);
  renderer.render(
      [](double x, double y, double z) { return (sin(x) + y) / z + x; },
      eye, -eye, 32, 32, 3.14/2,
      light, "Test.png");
}
